...
namespace LeagueOfLegendsFindTeamApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(CompanyRepository companyRepository)
        {
            _companyRepository = companyRepository;
        }

        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, CompanyRepository companyRepository)
        {
